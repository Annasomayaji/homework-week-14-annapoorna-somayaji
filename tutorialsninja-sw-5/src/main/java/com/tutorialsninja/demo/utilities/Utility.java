...
public class Utility extends ManageBrowser {
    ...
    /**
     * This is an overloaded method of clickOnElement above
     */
    ...
    /**
     * This is an overloaded getTextMethod
     */
    ...
    /**
     * This method is an overloaded method send text on element
     */
...
//*************************** Action Methods ***************************************//
     ...
     */
    public void moveMouseOnElementAndClick(WebElement element) {
        Actions actions = new Actions(driver);
    ...
    public List<WebElement> waitUntilVisibilityOfElementLocated(List<WebElement> listOfElement, int time) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(time));
        return wait.until(ExpectedConditions.visibilityOfAllElements(listOfElement));
    }
